...
export default function Leftbar() {
  ...
  return (
  <div className='leftBar lg:w-auto bg-white fixed left-0 sm:w-full sm:left-auto msm:hidden sm:justify-evenly sm:bottom-0 sm:flex-row z-50 sm:items-center allStorySec h-5/6 sm:h-auto sm:pt-0 overflow-scroll pt-5 w-64 flex flex-col shadow-md rounded-sm ml-3 mt-5'>
